...
import com.bz.selon.SelonItemApp;
...
@SpringBootTest(classes = SelonItemApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class SelonItemKafkaResourceIT {
    ...
    @Autowired
    private SelonItemKafkaProducer producer;

    @Autowired
    private SelonItemKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        SelonItemKafkaResource kafkaResource = new SelonItemKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/selon-item-kafka/publish?message=test"))
